...
<!-- FRONTMATTER RULES:
     ...
     The S29 and 2026-06-24-service-hardware-singleton-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Make the qdrant binary resolvable under the isolated test STATUS_DIR so the service-lifecycle integration tests exercise the live daemon attach and lock path instead of fast-failing on the binary guard in this env and ## Scope

- `src/vaultspec_rag/tests/integration/_helpers.py` placeholders below are machine-filled
