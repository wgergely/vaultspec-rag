...
related:
  ...
  - '[[2026-04-02-service-graph-phase3-step1-exec]]'
...
# `service-graph` feature index

Auto-generated index of all documents tagged with `#service-graph`.

## Documents

### adr

- `2026-04-02-service-graph-adr` - `service-graph` adr: service orchestration layer | (**status:** `accepted`)

### audit

- `2026-04-02-service-graph-code-review-audit` - `service-graph` Code Review
...
- `2026-04-02-service-graph-phase1-plan` - `service-graph` phase-1 plan
- `2026-04-02-service-graph-roadmap-plan` - `service-graph` roadmap

### research

- `2026-04-02-service-graph-research` - `service-graph` research: service orchestration layer
